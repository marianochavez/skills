...
- **[setup-matt-pocock-skills](./setup-matt-pocock-skills/SKILL.md)** — Configure this repo for the engineering skills (issue tracker — GitHub, GitLab, local markdown, or a personal Obsidian vault — triage labels, domain doc layout). Run once per repo.
